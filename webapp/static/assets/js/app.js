...
var App = function() {
    ...
    var page, pageContent, header, sidebar, sBrand, sExtraInfo, sidebarAlt, sScroll, sScrollAlt, current_page;
    ...
    var ChangeSideBar = function(extra){
        if (extra == "network")
        {
            document.getElementById("network_settings").style.display = "block";
        ...
        if (mode === 'init') {
            ...
            if (mode === 'toggle-sidebar') {
                ...
                if ( windowW > 991) { // Toggle alternative sidebar in large screens (> 991px)
                    toggle_class = 'sidebar-alt-visible-lg';
                }
                else
                {
                    toggle_class = 'sidebar-alt-visible-xs';
                }

                if (current_page == extra) {
                    page.toggleClass(toggle_class);
                }
                else {
                     if (!page.hasClass(toggle_class)) {
                         page.toggleClass(toggle_class);
                     }
                    current_page = extra;
                }
